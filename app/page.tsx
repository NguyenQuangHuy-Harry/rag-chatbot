        ...
        <section className="chatbot-section flex flex-col origin:w-[800px] w-full origin:h-[735px] h-full rounded-md p-2 md:p-6">
          <div className="chatbot-header pb-6">
            ...
            <p className="chatbot-text-secondary-inverse text-sm md:text-base mt-2 md:mt-4">
              Chatting with the Pagefly chatbot is effortless! Just type your
              questions or requests clearly and concisely. The chatbot will
              provide answers directly from Pagefly&lsquo;s knowledge base, and
              you&rsquo;ll also get a link for further reading to enhance your
              experience.
            </p>
          </div>
